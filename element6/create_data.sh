...
for i in \
    ...
    "$out_dir/culled/ExteriorLightsEvents.csv","$bsm_dir/ExteriorLightsEvents.csv","$bsm_dir/ExteriorLightsEvents.csv.zip","1","87","4","292780035494795","5","292806339899799","RxDevice|FileId|TxDevice|StartTime|Endtime|Value" \
